...
/// <summary>Provides access to libc library functions.</summary>
public static class libc
{
    ...
    internal static class SafeNativeMethods
    {
        ...
        [DllImport(Library, CallingConvention = Cdecl, CharSet = CharSet.Auto, BestFitMapping = false, ThrowOnUnmappableChar = true)]
